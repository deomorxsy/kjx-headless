...
USAGE: iptables-setup [-options]
                ...
                - help
eg,
MODE="iptables-setup-aio" . iptables-setup.sh   # Fetch dependencies for all-in-one iptables-setup
MODE="firecracker"  . iptables-setup.sh   # Setup firecracker as main microvm
MODE="gvisor"       . iptables-setup.sh   # Setup gvisor as main microvm
MODE="kata"         . iptables-setup.sh   # Setup kata-containers as main microvm
